...
// First, remove ALL occurrences of heroImage to clean up the duplicates
content = content.replace(/\n\s*"heroImage":\s*"[^"]+",/g, '');

// Then add exactly one heroImage for each slug
const gifs = {
...
console.log('Fixed hero images. Matched ' + matchedCount + ' pages.');
