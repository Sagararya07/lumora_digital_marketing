          ...
          <div className="flex flex-col">
            ...
            <div>
              <button
                ...
                className="px-8 py-4 rounded-full bg-gradient-to-r from-[#5B8EE2] via-[#D6A67B] to-[#EC4899] hover:from-[#4676C2] hover:via-[#C29367] hover:to-[#DB2777] text-white text-base font-extrabold flex items-center justify-center gap-3 shadow-xl shadow-blue-500/25 transition-all hover:scale-105 font-['Plus_Jakarta_Sans',sans-serif] group"
              >
                <span className="relative z-10 tracking-wide">Discover Custom Strategy Options</span>
