        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-10 mb-12">
          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <a href="https://x.com/Lumoradgtal" target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-full bg-[#F8FAFC] text-[#6B7280] hover:text-[#5B8EE2] hover:bg-[#F2F6FC] transition-colors border border-[#E5E7EB]">
                <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
              </a>
              <a href="https://www.facebook.com/profile.php?id=61593512968089" target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-full bg-[#F8FAFC] text-[#6B7280] hover:text-[#5B8EE2] hover:bg-[#F2F6FC] transition-colors border border-[#E5E7EB]">
                <Facebook className="w-4 h-4" />
              </a>
              <a href="https://www.instagram.com/lumoradgtal/" target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-full bg-[#F8FAFC] text-[#6B7280] hover:text-[#5B8EE2] hover:bg-[#F2F6FC] transition-colors border border-[#E5E7EB]">
                <Instagram className="w-4 h-4" />
              </a>
              <a href="https://www.youtube.com/@LumoraDgtal" target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-full bg-[#F8FAFC] text-[#6B7280] hover:text-[#5B8EE2] hover:bg-[#F2F6FC] transition-colors border border-[#E5E7EB]">
                <Youtube className="w-4 h-4" />
              </a>
              <a href="https://whatsapp.com/channel/0029VbDFlR83GJOsKsMPHl1v" target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-full bg-[#F8FAFC] text-[#6B7280] hover:text-[#5B8EE2] hover:bg-[#F2F6FC] transition-colors border border-[#E5E7EB]">
                <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-[#6B7280] font-normal">
              <a href={`mailto:${contactInfo?.email || 'contact@lumora.ai'}`} className="flex items-center gap-2.5 group hover:text-[#5B8EE2] transition-colors break-all">
                <Mail className="w-4 h-4 text-[#5B8EE2] shrink-0" />
                <span>
                  {contactInfo?.email || 'contact@lumora.ai'}
                </span>
              </a>
              <a href={`https://wa.me/${(contactInfo?.whatsapp || contactInfo?.phone || '919998887766').replace(/[^0-9]/g, '')}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2.5 group hover:text-[#5B8EE2] transition-colors">
