              ...
              <button
                ...
                className={`px-5 py-2.5 rounded-full text-xs font-extrabold transition-all duration-300 font-['Plus_Jakarta_Sans',sans-serif] ${
                  selectedIndustry === cat
                    ...
                    : 'bg-white text-[#6B7280] hover:text-[#111827] border border-[#E5E7EB] hover:border-[#2563EB]'
                }`}
              >
                <span>{cat}</span>
              </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredAchievements.map((item, idx) => (
              <div
                ...
                className="p-8 rounded-3xl bg-white border border-[#E5E7EB] hover:border-[#2563EB] shadow-xs hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group flex flex-col justify-between cursor-pointer relative overflow-hidden"
              >
                <div>
                ...
                <div className="pt-4 border-t border-slate-100 flex items-center justify-between text-xs text-[#2563EB] font-extrabold font-['Plus_Jakarta_Sans',sans-serif]">
